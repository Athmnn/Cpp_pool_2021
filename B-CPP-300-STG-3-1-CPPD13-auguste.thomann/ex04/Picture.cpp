...
** Last update Wed Jan 19 18:44:59 2021 
*/
...
Picture::Picture(Picture const &picture) noexcept : _data{picture.getPicture()}
{}
...
std::string Picture::getPicture() const noexcept
{
    return _data;
}
