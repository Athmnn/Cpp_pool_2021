/*
** Federation.cpp for B-CPP-300-STG-3-1-CPPD07M-auguste.thomann in /home/auguste/delivery/tek2/CPP_pool/day07/B-CPP-300-STG-3-1-CPPD07M-auguste.thomann
**
** Made by 
** Login   <>
**
** Started on  Wed Jan 13 09:08:08 2021 
** Last update Thu Jan 13 09:08:12 2021 
*/
...
Federation::Starfleet::Captain *Federation::Starfleet::Ship::getCaptain() const
{
    return _captain;
}
...
Federation::Starfleet::Ensign::Ensign(std::string const name): _name{name}
{
